...
- (void)setUp {
    ...
    _analyse = [[WZXTxtAnalyse alloc] initWithTxtName:_name font:[UIFont systemFontOfSize:13] bounds:CGRectMake(0, 0, self.view.frame.size.width - 20, self.view.frame.size.height - 120)];
